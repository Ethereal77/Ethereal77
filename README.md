...
I’m a .NET developer with hands-on experience building complete solutions as a freelancer:
APIs, backend systems, external service integrations, and performance optimization.
I enjoy working autonomously, understanding real-world problems, and delivering functional,
maintainable software.

I’m particularly interested in building efficient, scalable systems with a strong focus
on performance and code quality.

I’m currently looking for a stable position where I can contribute from day one and continue
growing into a mid-level role.
...
- Designed and implemented a REST API integrating an internal system with an external provider,
...
Through this, I’ve gained experience working with established codebases, participating in code reviews,
and collaborating in distributed teams.

Currently most active on [Stride Game Engine](https://github.com/stride3d/Stride), and recently
contributing to [.NET Community Toolkit](https://github.com/CommunityToolkit/dotnet).
...
These areas have strengthened my understanding of performance, memory management,
